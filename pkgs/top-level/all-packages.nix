...
let
  ...
  pkgsX = lib.fix' (lib.extend (lib.extend pkgsFun stdenvOverrides) configOverrides);
  ...
  # We use pkgs_ because accessing pkgs would lead to an infinite recursion
...
in lib.mapAttrs tweakAlias aliases // pkgsRet; in pkgsX
